...
void WelcomeProgram() {
    cout << "Hello! Welcome to our program! There are 2 options. Please choose one and let's start!" << endl;
}
...
void WelcomeGame() {
    ...
    cout << "Welcome to crossword heaven!If you are looking for a crossword puzzle that is quick and fun, check out our game!" << endl;
    cout << endl;
    cout << "Playing our crossword puzzle is very easy.Simply read the clues and then type the answers into the crossword puzzle.Good luck!" << endl;
...
void Game() {
    ...
    cout << "Hello! You chose play game In this game you have to guess the words. Let's begin!" << endl;
    cout << endl;
    level();
    cout << "I choose:";
    cin >> choice;
